...
ggplot(dans_ras_melt, aes(x = gene, y = type, fill = corr)) +
...
ComplexHeatmap::Heatmap(regulonActivity_byCellType_Scaled[1:160,], name="Regulon activity",row_names_gp =gpar(fontsize = 5))
